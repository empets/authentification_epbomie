          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: AppColorsProfile.primary.withValues(alpha: 0.2),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ).animate(delay: 250.ms).fadeIn(duration: 600.ms).slideY(begin: 0.2, end: 0),
  ...
  Widget build(BuildContext context) {
    return VisibilityDetector(
      ...
      child: Column(
        ...
        children: [
          // Icône
          Icon(widget.icon, color: AppColorsProfile.primary, size: 20),
          const SizedBox(height: 8),
