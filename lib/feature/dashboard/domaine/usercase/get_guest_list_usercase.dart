...
@lazySingleton
class GetGuestListUsercase implements UseCase<List<GuestResponse>, RequestGetProfile> {
  GetGuestListUsercase(this.repository);

  final HomeDomaineRepository repository;

  @override
  Future<Either<Failure, List<GuestResponse>>> call(RequestGetProfile params) {
    return repository.getGuestList(params);
  }
}
